"""
    Тесты для проверки регистрации пользователей в FastAPI-приложении.
    ...
    Сценарии:
        - test_register_success:
            ...
            Ожидается:
                * редирект на /courses,
                * создание пользователя в базе данных с правильным именем.

        - test_register_duplicate_email:
            Проверяет регистрацию с уже существующим email.
            Ожидается:
                * редирект обратно на /auth/register,
                * установка flash-сообщения об ошибке,
                * пользователь с дубликатом не создаётся.
"""
